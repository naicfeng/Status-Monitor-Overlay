...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        if (isFPSGraphMode) {
            ...
            if (isMicroMode) {
                auto* batteryOnlyDisplayPercentage = new tsl::elm::ToggleListItem("Battery Only Display Percentage", getCurrentBatteryOnlyDisplayPercentage());
                batteryOnlyDisplayPercentage->setStateChangedListener([this, section](bool state) {
